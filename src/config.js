...
export function loadConfig() {
  ...
  return {
    ...
    supportEnabled: parseBoolean(process.env.SUPPORT_ENABLED, true),
    supportBotToken: process.env.SUPPORT_BOT_TOKEN || '',
    supportBotUsername: process.env.SUPPORT_BOT_USERNAME || '',
    supportContactUrl: process.env.SUPPORT_CONTACT_URL || '',
    supportAdminIds: new Set(parseList(process.env.SUPPORT_ADMIN_IDS).map(String)),
    supportRateLimitWindowMs: Math.max(1_000, parseInteger(process.env.SUPPORT_RATE_LIMIT_WINDOW_MS, 60_000)),
    supportRateLimitMaxMessages: Math.max(1, parseInteger(process.env.SUPPORT_RATE_LIMIT_MAX_MESSAGES, 6)),
    aiProvider,
    ...
    dailyQuota: parseInteger(process.env.DAILY_QUOTA, 20),
    ...
    starsFreeQuota: Object.freeze({
      chat: parseNonNegativeInteger(process.env.STARS_FREE_CHAT_DAILY, parseNonNegativeInteger(process.env.DAILY_QUOTA, 20)),
      vision: parseNonNegativeInteger(process.env.STARS_FREE_VISION_DAILY, 3),
      image_generation: parseNonNegativeInteger(process.env.STARS_FREE_IMAGE_DAILY, 1),
      tts: parseNonNegativeInteger(process.env.STARS_FREE_TTS_DAILY, 2),
      live_voice: parseNonNegativeInteger(process.env.STARS_FREE_LIVE_VOICE_DAILY, 2),
    ...
    starsFreeChatZeroMeansUnlimited: process.env.STARS_FREE_CHAT_DAILY === undefined
      && parseNonNegativeInteger(process.env.DAILY_QUOTA, 20) === 0,
